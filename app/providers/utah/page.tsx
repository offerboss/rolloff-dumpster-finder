...
export const metadata: Metadata = {
  title: 'Utah Dumpster Rental Companies | Provider Directory',
  description:
    'Find verified roll-off dumpster rental companies serving Utah. Browse local providers by city, service area, and container size, or submit a listing for your company.',
  alternates: {
  ...
  openGraph: {
    title: 'Utah Dumpster Rental Companies | Provider Directory',
    description:
      'Find verified roll-off dumpster rental companies serving Utah. Browse local providers by city, service area, and container size.',
  ...
  twitter: {
    ...
    title: 'Utah Dumpster Rental Companies | Provider Directory',
    description:
      'Find verified roll-off dumpster rental companies serving Utah.',
    images: [
...
const featuredSlots = [
  {
    position: 'A',
    areas: 'Salt Lake City · Salt Lake Valley · Wasatch Front',
  },
  {
    position: 'B',
    areas: 'Utah Valley · Provo · Orem',
  },
]
      ...
      <section className="relative bg-[#1A2530] py-20 px-8 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <h1 className="text-[clamp(30px,5vw,52px)] font-extrabold text-white leading-[1.08] tracking-tight mb-5">
            Utah Dumpster Rental Companies
          </h1>
          <p className="text-[17px] text-white/[.58] max-w-[600px] leading-[1.65]">
            Verified roll-off dumpster rental companies serving Utah cities. Browse by service
      ...
      <section className="bg-white border-y border-[#E8E4DE] py-16 px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-[15px] text-[#6B7280] leading-[1.6] mb-10">
            Verified roll-off dumpster rental companies serving Utah. Standard listings include
          ...
          {standard.length > 0 ? (
            ...
            <div className="border border-dashed border-[#D0CCC5] rounded-sm px-8 py-12 text-center">
              ...
              <a
                href="mailto:adam@meetadamchandler.com?subject=Standard Listing Request — Utah"
