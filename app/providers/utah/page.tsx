...
import { utahProviders } from '@/content/providers'

export const metadata: Metadata = {
  title: 'Utah Roll-Off Dumpster Rental Companies | Provider Directory',
  description:
    'Browse roll-off dumpster rental companies serving Utah by region. Listings are compiled from public business information and have not yet been confirmed by providers.',
  alternates: {
    canonical: 'https://rolloffdumpsterfinder.com/providers/utah',
  },
  openGraph: {
    title: 'Utah Roll-Off Dumpster Rental Companies | Provider Directory',
    description:
    ...
    images: [
      {
        ...
        width: 1448,
        height: 1086,
        alt: 'Roll-off dumpster rental companies in Utah',
      },
    ],
  },
  twitter: {
    ...
    title: 'Utah Roll-Off Dumpster Rental Companies | Provider Directory',
    description:
      'Browse roll-off dumpster rental companies serving Utah by region.',
    images: [
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Utah',
      item: 'https://rolloffdumpsterfinder.com/providers/utah',
    },
  ],
}
...
const regions = [
  {
    key: 'Wasatch Front / SLC Metro',
    label: 'Wasatch Front / SLC Metro',
    desc: 'Serving Salt Lake City, West Valley City, Ogden, Provo, Sandy, Lehi, Murray, Millcreek, West Jordan, South Jordan, American Fork, Springville, Mapleton, Park City, Heber City, Tooele, and surrounding Wasatch Front communities.',
  },
  {
    key: 'Northern Utah',
    label: 'Northern Utah',
    desc: 'Serving Logan, North Logan, Brigham City, Garland, and communities throughout Cache Valley and Box Elder County.',
  },
  {
    key: 'Southern Utah',
    label: 'Southern Utah',
    desc: 'Serving St. George, Washington City, Cedar City, Hurricane, and surrounding communities in Washington County and Iron County.',
  },
  {
    key: 'Southern/Northern/Eastern Utah',
    label: 'Southern/Northern/Eastern Utah',
    desc: 'Serving rural and eastern Utah communities including Coalville, Erda, Duck Creek Village, Enterprise, Sanpete County, and the Uinta Basin.',
  },
]
...
const featuredSlots = [
  {
    position: 'A',
    areas: 'Salt Lake City · Wasatch Front · Salt Lake Valley',
  },
  {
    position: 'B',
    areas: 'Utah Valley · Provo · Ogden',
  },
]

export default function UtahProvidersPage() {
  const featured = utahProviders.filter((p) => p.featured)
  const standard = utahProviders.filter((p) => !p.featured)
    ...
    <>
      ...
      <section className="relative bg-[#1A2530] py-20 px-8 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <h1 className="text-[clamp(30px,5vw,52px)] font-extrabold text-white leading-[1.08] tracking-tight mb-5">
            Utah Roll-Off Dumpster Rental Companies
          </h1>
          <p className="text-[17px] text-white/[.58] max-w-[600px] leading-[1.65]">
            Roll-off dumpster rental companies serving Utah, organized by service region. Standard
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-12">
          <div className="max-w-[560px]">
            ...
            <p className="text-[14px] text-[#566070] leading-[1.7]">
              The directory covers providers across Salt Lake City, West Valley City, Provo, Ogden,
              Sandy, and Lehi in the Wasatch Front corridor, plus Logan, St. George, Cedar City, and
              communities statewide. Common jobs include home cleanouts, roofing tear-offs,
              construction debris removal, full gut renovations, estate cleanouts, and new build
              site cleanup.
            </p>
          </div>
          <div className="shrink-0">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-[6px]">
              {[
                { label: 'Salt Lake City', href: '/locations/salt-lake-city-ut-dumpster-rental' },
                { label: 'West Valley City', href: '/locations/west-valley-city-ut-dumpster-rental' },
                { label: 'Provo', href: '/locations/provo-ut-dumpster-rental' },
                { label: 'Ogden', href: '/locations/ogden-ut-dumpster-rental' },
                { label: 'Sandy', href: '/locations/sandy-ut-dumpster-rental' },
                { label: 'Lehi', href: '/locations/lehi-ut-dumpster-rental' },
              ].map((city) => (
                <Link
                  key={city.href}
                  href={city.href}
      ...
      <section className="bg-[#F5F4F0] py-16 px-8">
        <div className="max-w-[1200px] mx-auto mb-10">
          ...
          <p className="text-[15px] text-[#6B7280] leading-[1.6]">
            We are looking for one strong preferred roll-off dumpster partner in each Utah service
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
            {featuredSlots.map((slot) => (
              ...
              >
                ...
                <a
                  href="mailto:adam@meetadamchandler.com?subject=Featured Listing Request — Utah"
                  className="inline-block bg-orange text-black font-bold text-[12px] px-[18px] py-[9px] rounded-full hover:opacity-90 transition-opacity self-start"
                >
      ...
      <section className="bg-white border-y border-[#E8E4DE] py-16 px-8">
        <div className="max-w-[1200px] mx-auto">
          <div className="w-10 h-[3px] bg-orange rounded-sm mb-[14px]" />
          <h2 className="text-[clamp(22px,3vw,30px)] font-extrabold text-charcoal tracking-tight mb-2">
            Utah Providers by Region
          </h2>
          <p className="text-[15px] text-[#6B7280] leading-[1.6] mb-1">
            {standard.length > 0
              ? `${standard.length} companies listed across Utah service regions.`
              : 'No standard listings yet for Utah.'}
          </p>
                  ...
                  <div className="border-t border-[#E8E4DE] bg-[#FAFAF8]">
                    {regionProviders.length > 0 ? (
                      ...
                      <div className="px-6 py-10 text-center">
                        ...
                        <a
                          href={`mailto:adam@meetadamchandler.com?subject=Listing Request — Utah, ${region.label}`}
      ...
      <section className="bg-[#F5F4F0] py-16 px-8">
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-start justify-between gap-12">
          ...
          <div className="shrink-0 flex flex-col gap-4">
            <a
              href="mailto:adam@meetadamchandler.com?subject=Provider Listing Request — Utah"
