...
import { oklahomaProviders } from '@/content/providers'

export const metadata: Metadata = {
  title: 'Oklahoma Roll-Off Dumpster Rental Companies | Provider Directory',
  description:
    'Browse roll-off dumpster rental companies serving Oklahoma by region. Listings are compiled from public business information and have not yet been confirmed by providers.',
  alternates: {
    canonical: 'https://rolloffdumpsterfinder.com/providers/oklahoma',
  },
  openGraph: {
    title: 'Oklahoma Roll-Off Dumpster Rental Companies | Provider Directory',
    description:
    ...
    images: [
      {
        ...
        width: 1448,
        height: 1086,
        alt: 'Roll-off dumpster rental companies in Oklahoma',
      },
    ],
  },
  twitter: {
    ...
    title: 'Oklahoma Roll-Off Dumpster Rental Companies | Provider Directory',
    description:
      'Browse roll-off dumpster rental companies serving Oklahoma by region.',
    images: [
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Oklahoma',
      item: 'https://rolloffdumpsterfinder.com/providers/oklahoma',
    },
  ],
}
...
const regions = [
  {
    key: 'OKC Metro / Central Oklahoma',
    label: 'OKC Metro / Central Oklahoma',
    desc: 'Serving Oklahoma City, Edmond, Norman, Yukon, Midwest City, Mustang, Moore, Warr Acres, Guthrie, El Reno, Jones, McLoud, Tecumseh, Stillwater, and surrounding central Oklahoma communities.',
  },
  {
    key: 'Tulsa Metro / Northeast Oklahoma',
    label: 'Tulsa Metro / Northeast Oklahoma',
    desc: 'Serving Tulsa, Broken Arrow, Sapulpa, Sand Springs, Jenks, Bartlesville, Kiefer, Checotah, Eufaula, Hoyt, and surrounding northeastern Oklahoma communities.',
  },
  {
    key: 'Southwest Oklahoma',
    label: 'Southwest Oklahoma',
    desc: 'Serving Lawton, Duncan, Elk City, Chickasha, and surrounding southwestern Oklahoma communities.',
  },
  {
    key: 'Southeast Oklahoma',
    label: 'Southeast Oklahoma',
    desc: 'Serving Ardmore, Durant, McAlester, Lone Grove, and surrounding southeastern Oklahoma communities.',
  },
  {
    key: 'Northwest Oklahoma / Panhandle',
    label: 'Northwest Oklahoma / Panhandle',
    desc: 'Serving Enid, Woodward, and communities across northwestern Oklahoma and the Panhandle.',
  },
]
...
const featuredSlots = [
  {
    position: 'A',
    areas: 'OKC Metro · Oklahoma City · Edmond · Norman',
  },
  {
    position: 'B',
    areas: 'Tulsa Metro · Broken Arrow · Bartlesville',
  },
]

export default function OklahomaProvidersPage() {
  const featured = oklahomaProviders.filter((p) => p.featured)
  const standard = oklahomaProviders.filter((p) => !p.featured)
    ...
    <>
      ...
      <section className="relative bg-[#1A2530] py-20 px-8 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <h1 className="text-[clamp(30px,5vw,52px)] font-extrabold text-white leading-[1.08] tracking-tight mb-5">
            Oklahoma Roll-Off Dumpster Rental Companies
          </h1>
          <p className="text-[17px] text-white/[.58] max-w-[600px] leading-[1.65]">
            Roll-off dumpster rental companies serving Oklahoma, organized by service region. Standard
          ...
          <p className="mt-5 text-[13px] text-white/[.36]">
            ...
            >
              Browse the Oklahoma renter guides
            </Link>
            .
          </p>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-12">
          <div className="max-w-[560px]">
            ...
            <p className="text-[14px] text-[#566070] leading-[1.7]">
              The directory covers providers across Oklahoma City, Edmond, Norman, and Yukon in the
              central metro, plus Tulsa, Broken Arrow, Bartlesville, and communities statewide.
              Common jobs include home cleanouts, roofing tear-offs, storm debris removal,
              construction debris, full renovation projects, and rural property cleanouts.
            </p>
          </div>
          <div className="shrink-0">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-[6px]">
              {[
                { label: 'Oklahoma City', href: '/locations/oklahoma-city-ok-dumpster-rental' },
                { label: 'Tulsa', href: '/locations/tulsa-ok-dumpster-rental' },
                { label: 'Norman', href: '/locations/norman-ok-dumpster-rental' },
                { label: 'Broken Arrow', href: '/locations/broken-arrow-ok-dumpster-rental' },
                { label: 'Edmond', href: '/locations/edmond-ok-dumpster-rental' },
                { label: 'Lawton', href: '/locations/lawton-ok-dumpster-rental' },
              ].map((city) => (
                <Link
                  key={city.href}
                  href={city.href}
      ...
      <section className="bg-[#F5F4F0] py-16 px-8">
        <div className="max-w-[1200px] mx-auto mb-10">
          ...
          <p className="text-[15px] text-[#6B7280] leading-[1.6]">
            We are looking for one strong preferred roll-off dumpster partner in each Oklahoma service
      ...
      <section className="bg-white border-y border-[#E8E4DE] py-16 px-8">
        <div className="max-w-[1200px] mx-auto">
          <div className="w-10 h-[3px] bg-orange rounded-sm mb-[14px]" />
          <h2 className="text-[clamp(22px,3vw,30px)] font-extrabold text-charcoal tracking-tight mb-2">
            Oklahoma Providers by Region
          </h2>
          <p className="text-[15px] text-[#6B7280] leading-[1.6] mb-1">
            {standard.length > 0
              ? `${standard.length} companies listed across Oklahoma service regions.`
              : 'No standard listings yet for Oklahoma.'}
          </p>
