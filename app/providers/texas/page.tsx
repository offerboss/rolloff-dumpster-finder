...
export const metadata: Metadata = {
  title: 'Texas Dumpster Rental Companies | Provider Directory',
  description:
    'Find verified roll-off dumpster rental companies serving Texas. Browse local providers by city, service area, and container size, or submit a listing for your company.',
  alternates: {
  ...
  openGraph: {
    title: 'Texas Dumpster Rental Companies | Provider Directory',
    description:
      'Find verified roll-off dumpster rental companies serving Texas. Browse local providers by city, service area, and container size.',
  ...
  twitter: {
    ...
    title: 'Texas Dumpster Rental Companies | Provider Directory',
    description:
      'Find verified roll-off dumpster rental companies serving Texas.',
    images: [
...
const featuredSlots = [
  {
    position: 'A',
    areas: 'Dallas–Fort Worth · DFW Metroplex · North Texas',
  },
  {
    position: 'B',
    areas: 'Houston Metro · Greater Houston · Harris County',
  },
  {
    position: 'C',
    areas: 'Austin · Central Texas · San Antonio',
  },
]
      ...
      <section className="relative bg-[#1A2530] py-20 px-8 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <h1 className="text-[clamp(30px,5vw,52px)] font-extrabold text-white leading-[1.08] tracking-tight mb-5">
            Texas Dumpster Rental Companies
          </h1>
          <p className="text-[17px] text-white/[.58] max-w-[600px] leading-[1.65]">
            Verified roll-off dumpster rental companies serving Texas cities. Browse by service
      ...
      <section className="bg-white border-y border-[#E8E4DE] py-16 px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-[15px] text-[#6B7280] leading-[1.6] mb-10">
            Verified roll-off dumpster rental companies serving Texas. Standard listings include
          ...
          {standard.length > 0 ? (
            ...
            <div className="border border-dashed border-[#D0CCC5] rounded-sm px-8 py-12 text-center">
              ...
              <p className="text-[13px] text-[#6B7280] leading-[1.65] max-w-[460px] mx-auto mb-6">
                We are currently onboarding verified providers across Dallas–Fort Worth, Houston,
                Austin, and San Antonio. Standard listings are free for local roll-off dumpster
                rental companies with confirmed service areas. Listings typically go live within
                two to three business days of submission.
              </p>
              <a
                href="mailto:adam@meetadamchandler.com?subject=Standard Listing Request — Texas"
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-start justify-between gap-12">
          <div className="max-w-[520px]">
            ...
            <p className="text-[15px] text-[#6B7280] leading-[1.7]">
              ...
              verified badge, direct phone number display, and a short company description. Texas
              has three featured slots available — DFW, Houston metro, and Austin/San Antonio.
            </p>
          </div>
